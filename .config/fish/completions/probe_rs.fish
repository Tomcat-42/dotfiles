...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l format -d 'Configure formatting of the test report output' -r -f -a "pretty\t'One line per test. Output for humans. (default)'
terse\t'One character per test. Usefull for test suites with many tests'
json\t'Json output'"
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l ignored -d 'If set, run only ignored tests'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l include-ignored -d 'If set, run ignored and non-ignored tests'
