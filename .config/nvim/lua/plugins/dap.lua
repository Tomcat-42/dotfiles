...
return {
  {
    ...
    keys = {
      { "<leader>dz", function() require("dap-view").toggle(true) end,                                      desc = "Toggle Dap View" },
      { "<leader>dw", function() require("dap-view").add_expr() end,                                        desc = "Dapview watch",        mode = { "n", "v" } },
      { "<leader>dc", function() require("dap").continue() end,                                             desc = "Dap continue" },
      { "<leader>dh", function() require("dap").step_into() end,                                            desc = "Dap step into" },
      ...
      { "<leader>dl", function() require("dap").step_back() end,                                            desc = "Dap step back" },
      { "<leader>dr", function() require("dap").restart() end,                                              desc = "Dap restart" },
      { "<leader>db", function() require("dap").toggle_breakpoint() end,                                    desc = "Dap toggle breakpoint" },
      { "<leader>dp", function() require("dap").set_breakpoint(vim.fn.input("Breakpoint Condition: ")) end, desc = "Dap set breakpoint" },
      { "<leader>di", function() require("dap.ui.widgets").hover(nil, { border = "single" }) end,           desc = "Dap set breakpoint" },
      {
        "<leader>ds",
        function()
