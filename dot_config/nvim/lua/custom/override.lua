...
M.telescope = {
    extensions_list = {
        "themes", "terms", "gh", "media_files", "repo", "z", "hoogle", "emoji",
        "command_palette", "env", "neoclip"
    },
    extensions = {
        command_palette = {
            {
                "File", {"entire selection (C-a)", ':call feedkeys("GVgg")'},
                {"save current file (C-s)", ':w'},
                {"save all files (C-A-s)", ':wa'}, {"quit (C-q)", ':qa'}, {
                    "file browser (C-i)",
                ...
                {
                    "files (C-f)",
                    ":lua require('telescope.builtin').find_files()", 1
                }
            }, {
